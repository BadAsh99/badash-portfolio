...
export const LLMGUARDT2_LINES: BootLine[] = [
  ...
  { text: "BASH99", delay: 2200, color: "text-terminal-green", big: true },
...
export const CLOUDGUARD_LINES: BootLine[] = [
  ...
  { text: "BASH99", delay: 2300, color: "text-terminal-green", big: true },
  { text: "SASE · SaaS SECURITY · BUILDER", delay: 2550, color: "text-terminal-cyan" },
